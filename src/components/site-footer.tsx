    ...
    <footer className="border-t border-black/10 py-10">
      <div className="editorial-container flex flex-col gap-4 text-[11px] uppercase tracking-[0.22em] text-muted md:flex-row md:flex-wrap md:items-center md:justify-between md:gap-x-8 md:gap-y-3">
        ...
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
          ...
          <a
            href="https://www.instagram.com/_ateliereleve/"
            target="_blank"
            rel="noreferrer noopener"
            aria-label="Atelier Élevé on Instagram (opens in a new tab)"
            className="inline-flex items-center text-current transition hover:text-ink"
          >
            <svg
